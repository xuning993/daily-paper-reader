...
tldr: 针对工业场景中复杂算法设计的挑战，本文提出了一种名为EvoStage的演化阶段式算法设计框架。该方法借鉴思维链（CoT）思想，将复杂的算法设计分解为多个可管理的阶段，并结合实时反馈进行迭代优化。通过引入多智能体系统和“全局-局部视角”机制，有效缩小了搜索空间并避免陷入局部最优。在芯片布局优化和贝叶斯优化任务中，EvoStage不仅超越了人类专家设计，还在商业级工具上刷新了性能记录，显著提升了生产力。
selection_source: fresh_fetch
motivation: 现有的基于大模型的算法设计方法多采用黑盒建模，缺乏对问题内在机制的理解，容易产生幻觉且难以应对复杂的工业级挑战。
method: 提出EvoStage框架，通过阶段式分解设计过程、引入实时中间反馈，并结合多智能体协作与全局-局部视角机制来优化算法。
result: 在芯片布局和黑盒优化基准测试中，EvoStage仅需少量演化步骤便超越了人类专家和现有LLM方法，并在商业级3D芯片工具上取得了破纪录的效率。
conclusion: EvoStage证明了通过结构化演化设计可以显著提升自动化算法设计的性能，为解决实际工业难题提供了高效且具有竞争力的自动化新范式。
---
